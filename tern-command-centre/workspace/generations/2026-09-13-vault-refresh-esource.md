---
title: Obsidian vault refresh — eSource, EdTech team, org chart (13 Sep)
type: vault
agent: hannah-brooks
...
Written to the Drive mirror of the vault from a cloud session; the Mac picks it up through the vault's Drive sync. The old versions sit beside the new ones as `.bak` files and can be deleted once the Mac has synced.
