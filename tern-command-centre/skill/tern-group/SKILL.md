...
1. Find the owning company, then the owner, in `references/org-structure.md` (tree) and `references/roster.md` (all 100 people with role, line manager, status and skills).
...
| Tern Academy | Dr. Sunita Raghavan, CEO & Principal | 9 | Aarshi's ICSE Class 8 (2026-27) run like a school; EdTech (FeatherQuest, Orbit) |
...
Front doors: any family health request → **Family Health Desk** (Meenakshi Sundaram); anything about Pluto or Bannu → **Divya Ramesh** then Dr. Nandini Bhat; anything about Aarshi's studies → **Dr. Sunita Raghavan**; anything Taurus / insurance / contact centre → **Diego Santos**.
