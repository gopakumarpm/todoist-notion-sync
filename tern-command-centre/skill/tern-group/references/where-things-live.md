...
### Records
- [Notion · Tern Group — Org Structure](https://app.notion.com/p/3d9cac843da681d4a123d42df11dd423) — Full structure + Tern Group Roster database (100 rows); readable by Max on every surface via the Notion connector
